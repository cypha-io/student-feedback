  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <div className="fixed top-4 right-4 z-10">
        <Link
          href="/"
          className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-full p-3 shadow-lg border border-white/20 dark:border-gray-700/50 hover:bg-white dark:hover:bg-gray-800 transition-all duration-200 group"
          title="Admin Login"
        >
