...
export default function Reports() {
  ...
  const topTeachers = [
    { name: 'Dr. Sarah Johnson', department: 'Mathematics', rating: 4.8, feedbacks: 156 },
    { name: 'Prof. Michael Brown', department: 'Science', rating: 4.7, feedbacks: 142 },
    { name: 'Dr. Emily Davis', department: 'English', rating: 4.6, feedbacks: 134 },
    { name: 'Prof. James Wilson', department: 'History', rating: 4.5, feedbacks: 128 },
    { name: 'Dr. Lisa Anderson', department: 'Computer Science', rating: 4.9, feedbacks: 167 },
  ];

  const recentFeedbacks = [
    { teacher: 'Dr. Sarah Johnson', student: 'Anonymous', rating: 5, comment: 'Excellent teaching method...', date: '2024-01-15' },
    { teacher: 'Prof. Michael Brown', student: 'Anonymous', rating: 4, comment: 'Very informative classes...', date: '2024-01-15' },
    { teacher: 'Dr. Emily Davis', student: 'Anonymous', rating: 5, comment: 'Great communication skills...', date: '2024-01-14' },
  ];
