  ...
  return (
    <div className={`min-h-screen flex items-center justify-center p-4 relative ${styles.heroBackground}`}>
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className={`${styles.cardGlass} rounded-2xl shadow-xl p-6 space-y-6 relative overflow-hidden`}>
          ...
          <div className="text-center space-y-4 relative z-10">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Built by SwapGPA Technologies Limited | Deployed for OLAGSHS
              </p>
          ...
          <div className="space-y-4 relative z-10">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300 focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 group"
            >
            ...
            <div className={`${styles.studentSectionGlass} rounded-xl p-5 group hover:scale-[1.02] transition-all duration-300`}>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 group"
              >
                <div className="flex items-center justify-center space-x-3">
          ...
          {/* Compact Footer */}
          <div className="text-center pt-4 border-t border-gray-200 relative z-10">
            <div className="flex items-center justify-center gap-3 text-xs text-gray-500 mb-2">
              ...
              <span className="inline-flex items-center gap-1">
                <svg className="w-3 h-3 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7a4 4 0 118 0v3m-9 4h10a2 2 0 012 2v1H5v-1a2 2 0 012-2z" />
                </svg>
                Anonymous
              </span>
              <span className="inline-flex items-center gap-1">
